...
// render would pin the page to English forever. The randomized order arrives
// from the request-rendered page and is therefore stable through hydration.
...
export function HomeContent({
  ...
  const games = gameOrder.flatMap((gameId) => {
  ...
  return (
    <main className="mx-auto flex min-h-dvh w-full max-w-md flex-col gap-6 px-5 pb-[max(3rem,env(safe-area-inset-bottom))] pt-[env(safe-area-inset-top)]">
      <header className="flex flex-col items-center gap-2 pt-10 text-center">
        <AegyoLogo className="h-20 w-20 drop-shadow-[0_0_18px_rgba(255,79,139,0.45)]" />
