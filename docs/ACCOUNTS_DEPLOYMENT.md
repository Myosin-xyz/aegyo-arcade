...
The current Accounts staging deployment is the configuration-only deployment `4546e488-b42c-43dd-b602-94fda7271c81` on existing runtime source `3841cf5`; Aegyo `d6844960-0524-4314-b4a6-7e31a7959e02`, Arcade `42427b71-3db6-4ce2-9d29-1053bbb7486e`, and Daebak `cad82133-f3ca-4251-8530-b25e589decb8` remain the recorded product previews. Their origins are listed in [the cross-product staging proof](CROSS_APP_STAGING_PROOF.md). Guarded fixture source `13b920a` passed 45 real-PostgreSQL checks after being copied to `/tmp` and run offline on the current staging container; it did not replace the runtime source. The product previews use separate logical databases and restricted roles on the same isolated staging Postgres service.
